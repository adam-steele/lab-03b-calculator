...
addButt.addEventListener('click', () => {
    ...
    const sum = addition(firstValue, secondValue);    
...
minusButt.addEventListener('click', () => {
    ...
    const subtract = subtraction(firstValue - secondValue);
...
multButt.addEventListener('click', () => {
    ...
    const multiply = multiply(firstValue * secondValue);
...
divButt.addEventListener('click', () => {
    ...
    const division =  divide(firstValue / secondValue);
